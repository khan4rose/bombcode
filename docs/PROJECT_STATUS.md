...
| Android viewport metrics 반복 / 자동 종료 | 관찰 중 | `WindowInsets changed`, `FlutterJNI: Sending viewport metrics`, `Lost connection to device` 로그가 간헐적으로 발생. `android:windowSoftInputMode="adjustNothing"` 적용 후 현재 정상 작동 확인됨 |
